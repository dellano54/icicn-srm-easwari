            ...
            <div className="overflow-x-auto max-h-[600px] custom-scrollbar">
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {papers.map(paper => (
                            <tr key={paper.id} className="hover:bg-slate-50/50">
                                <td className="p-4">
                                    ...
                                    <div className="text-[10px] text-slate-400 font-mono mt-1">Domains: {paper.domains.slice(0, 2).join(', ')}...</div>
                                </td>
                                ...
                                <td className="p-4 text-right">
                                    <span className="inline-block px-2 py-1 rounded text-[10px] font-bold uppercase bg-red-100 text-red-700">
                                        Rejected
                                    </span>
                                </td>
                            </tr>
                        ...
                        {papers.length === 0 && (
                            <tr>
                                <td colSpan={4} className="p-8 text-center text-slate-400 italic">No rejected papers.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
